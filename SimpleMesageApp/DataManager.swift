...
class DataManager {
    ...
    var botMessages: [String:Message] {
        ["Когда сделаете нормальный тачпад?)": Message(text: "Для игр тачпад не нужен 😉", person: userTwo.profile ),
        "У тебя есть яблоки?": Message(text: "Есть, но только наткусанные? 😉", person: userOne.profile)]
    }
}
